...
find_path(CyrusSASL_INCLUDE_DIR
    NAMES sasl/sasl.h
    PATHS ${CONAN_INCLUDE_DIRS_CYRUS-SASL}
    NO_DEFAULT_PATH
)

find_library(CyrusSASL_LIBRARY
    NAMES sasl2
    PATHS ${CONAN_LIB_DIRS_CYRUS-SASL}
    NO_DEFAULT_PATH
)
...
if(CyrusSASL_FOUND AND NOT TARGET CyrusSASL::CyrusSASL)
    ...
    set_target_properties(CyrusSASL::CyrusSASL PROPERTIES
        ...
        INTERFACE_COMPILE_DEFINITIONS "${CONAN_COMPILE_DEFINITIONS_CYRUS-SASL}"
    )
    ...
    set(CyrusSASL_DEFINITIONS "${CONAN_COMPILE_DEFINITIONS_CYRUS-SASL}")
